...
public class TesakanHomeFragment extends Fragment {
    ...
    public static TesakanHomeFragment newInstance(String param1, String param2) {
        TesakanHomeFragment fragment = new TesakanHomeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int a = getArguments().getInt("inch_vor_key");
